              ...
              <div class="card-body">
                ...
                <form>         
                      ...
                      <div className='d-flex'>
                        ...
                        <input type="text" class="form-control" value= {localStorage.getItem('user_data') ? "username" : "Change Username"} aria-label="Change Username"/>
                      </div>

                      <div className='d-flex'>
                        <label>Password:</label>
                        <input type="text" class="form-control" value= {localStorage.getItem('user_data') ? "results" : "Change Password"} aria-label="Change password" aria-describedby="button-addon2"/>
                      </div>
                      ...
                      <div className='d-flex'>
                        ...
                        <input type="text" class="form-control" value= {localStorage.getItem('user_data') ? "first name" : "Change First Name"} aria-label="Change First Name" aria-describedby="button-addon2"/>
                      </div>

                      <div className='d-flex'>
                        <label>Last Name:</label>
                        <input type="text" class="form-control" value= {localStorage.getItem('user_data') ? "last name" : "Change Last Name"} aria-label="Change Last Name" aria-describedby="button-addon2"/>
                        </div>
                      
                      <div className='d-flex'>
                        <label>Phone Number:</label>
                        <input type="text" class="form-control" value= {localStorage.getItem('user_data') ? "number" : "Change Phone Number"} aria-label="Change Phone Number" aria-describedby="button-addon2"/>
                      </div>
